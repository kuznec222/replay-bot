...
PHOTO_X      = 238   # отступ от левого края шаблона
PHOTO_Y      = 520   # отступ от верхнего края шаблона
PHOTO_W      = 315   # ширина области фото
PHOTO_H      = 315   # высота области фото
...
YEAR_X       = 290   # координата X начала текста года
YEAR_Y       = 310   # координата Y текста года
